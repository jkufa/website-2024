...
<SlideInOut>
	<a
		{href}
		draggable="false"
		class="flex w-full items-center justify-between gap-8 px-[2em] py-[1.25em] text-off-black focus-visible:outline-none text-clamp-base font-extrabold uppercase"
